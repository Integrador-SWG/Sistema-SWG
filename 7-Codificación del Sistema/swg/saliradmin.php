...
<html lang="es">
  ...
  <?php include_once "menu/m_login.php"; ?>
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post" name="acceder">
        ...
        <br>
        <center><a class="btn btn-success btn-large" href="salir.php">Salir</a>
        <a class="btn btn-danger btn-large" href="modulos/admin/index.php">Regresar</a></center>
        </form>
      <!--</form>-->
