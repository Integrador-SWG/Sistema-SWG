                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Actualizar Administrador
                            </li>
                        </ol>
                    </div>
                </div>
...
<form class="form-horizontal" action="actualizaradministrador.php?idusuario=<?php echo $idusuario?>" method="post" name="actualizar" role="form">
