    ...
    <!-- Navigation -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Listar Administradores
                            </li>
                        </ol>
                    </div>
                </div>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered">
             ...
             empleados.idusuario = usuario.idusuario WHERE idnivel = "administrador"';
             ...
             foreach ($pdo->query($sql) as $row) {
                  ...
                  //echo '<td width=250>';
                  echo '<td width=160>';
                  echo '<a class="btn btn-warning" href="veradministrador.php?idusuario='.$row['idusuario'].'">Ver</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-success" href="actualizaradministrador.php?idusuario='.$row['idusuario'].'">Actualizar</a>';
                  /*echo '&nbsp;';
