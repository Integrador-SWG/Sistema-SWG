...
if ( !empty($_POST)) {
  ...
  // keep track post values
    ...
    /*if (empty($idconfvista)) {
      $idconfvistaError = 'Por favor, ingrese un confvista!';
      $valid = false;
    }*/
  ...
  if($valid){
      ...
      $sql = "INSERT INTO confvista (nombre,slide1,info1,slide2,info2,slide3,info3,estatus) values(?, ?, ?, ?, ?, ?, ?, ?)";
      $q = $pdo->prepare($sql);
      ...
      $sql = "INSERT INTO empresa (direccion,correo,idconfvista) values(?, ?, ?)";
      $q = $pdo->prepare($sql);
      $q->execute(array($direccion,$correo,$resultado));
      $resultado1 = $pdo->lastInsertId();

      //despues la de cliente
      $sql = "INSERT INTO cuentas (banco,nombre,cuenta,estatus,idempresa) values(?, ?, ?, ?, ?)";
      $q = $pdo->prepare($sql);
      $q->execute(array($banco,$nombre,$cuenta,$estatus,$resultado1));      
...
<body>
    ...
    <!-- Navigation -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-edit"></i> Registro Empresa
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <form class="form-horizontal" action="altaempresa.php" method="post" name="alta" enctype="multipart/form-data">

                  <!--Cursor en formulario-->
          <body onload = "document.alta.direccion.focus()">
