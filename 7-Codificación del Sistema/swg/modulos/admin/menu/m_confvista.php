                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="listar" class="collapse">
                            <li>
                                <a href="../clientes/listarclientes.php">Clientes</a>
                            </li>
                            <li>
                                <a href="../clientes/listarusuarios.php">Usuario</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="altaadministrador.php"><i class="fa fa-fw fa-edit"></i> Registrar</a>
                    </li>
                    <li>
